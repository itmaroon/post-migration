...
<?php
        ...
        public function enqueue_scripts()
        {
            ...
            wp_enqueue_script('progress-overlay', plugin_dir_url(__FILE__) . 'assets/js/itmar-progress-overlay.js', ['jquery', 'wp-i18n'], filemtime("$dir/assets/js/itmar-progress-overlay.js"), true);
        }
    }
